...
equation
  ...
  connect(electricModelWithRealOut.pin_p, pin_p) annotation (Line(points={{-10,
          -40},{-40,-40},{-40,0},{-100,0}}, color={0,0,255}));
  connect(resistor.p, pin_p) annotation (Line(points={{-10,40},{-40,40},{-40,0},
          {-100,0}}, color={0,0,255}));
