...
model MetalCan60Ah_essl
  "60Ah metal-can cell with parameters from DOI: 10.1149/1945-7111/abbe5a Cell #2"
  extends Architectures.ParametrizeableCellModelWithThermalAndElectricalSystem(
    ...
    redeclare
      ...
      transfer,
    redeclare Subsystems.HeatTransfer2D_accellerating
                                        heatStorageAndTransmission(
