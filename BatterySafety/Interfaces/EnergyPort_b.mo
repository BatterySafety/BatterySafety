...
connector EnergyPort_b "Energy port for 1-dim. energy transfer (unfilled rectangular icon)"
...
<p>According to the Modelica sign convention, a <b>positive</b> energy flow
