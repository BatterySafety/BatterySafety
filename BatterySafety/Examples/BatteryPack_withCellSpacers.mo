...
model BatteryPack_withCellSpacers "Battery Pack Example"
  extends Modelica.Icons.Example;
  CellModels.Module12_withSpacer M_01(T_0=global.T_0) annotation (Placement(
        transformation(
        extent={{-16,-10},{16,10}},
        rotation=90,
        origin={-170,-80})));
  Subsystems.PackPlate PackPlate(T_0=global.T_0)
        ...
        rotation=90,
        origin={-153,-80})));
  CellModels.Module12_withSpacer M_02(T_0=global.T_0) annotation (Placement(
        transformation(
        extent={{16,-10},{-16,10}},
        rotation=90,
        origin={-136,-80})));
  Subsystems.PackPlate PackPlate1(T_0=global.T_0)
        ...
        rotation=90,
        origin={-119,-80})));
  CellModels.Module12_withSpacer M_03(T_0=global.T_0) annotation (Placement(
        transformation(
        extent={{-16,-10},{16,10}},
        rotation=90,
        origin={-102,-80})));
  Subsystems.PackPlate PackPlate2(T_0=global.T_0)
        ...
        rotation=90,
        origin={-79,-80})));
  CellModels.Module12_withSpacer M_04(T_0=global.T_0) annotation (Placement(
        transformation(
        extent={{16,-10},{-16,10}},
        rotation=90,
        origin={-54,-80})));
  Subsystems.PackPlate PackPlate3(T_0=global.T_0)
        ...
        rotation=90,
        origin={-37,-80})));
  CellModels.Module12_withSpacer M_05(T_0=global.T_0) annotation (Placement(
        transformation(
        extent={{-16,-10},{16,10}},
        rotation=90,
        origin={-20,-80})));
  Subsystems.PackPlate PackPlate4(T_0=global.T_0)
        ...
        rotation=90,
        origin={-3,-80})));
  CellModels.Module12_withSpacer M_06(T_0=global.T_0) annotation (Placement(
        transformation(
        extent={{16,-10},{-16,10}},
        rotation=90,
        origin={14,-80})));
  Subsystems.PackPlate PackPlate5(T_0=global.T_0)
        ...
        rotation=90,
        origin={31,-80})));
  CellModels.Module12_withSpacer M_07(T_0=global.T_0) annotation (Placement(
        transformation(
        extent={{-16,-10},{16,10}},
        rotation=90,
        origin={48,-80})));
  Subsystems.PackPlate PackPlate6(T_0=global.T_0)
        ...
        rotation=90,
        origin={65,-80})));
  CellModels.Module12_withSpacer M_08(T_0=global.T_0) annotation (Placement(
        transformation(
        extent={{16,-10},{-16,10}},
        rotation=90,
        origin={82,-80})));
  Subsystems.PackPlate PackPlate7(T_0=global.T_0)
        ...
        rotation=90,
        origin={99,-80})));
  CellModels.Module12_withSpacer M_09(T_0=global.T_0) annotation (Placement(
        transformation(
        extent={{-16,-10},{16,10}},
        rotation=90,
        origin={116,-80})));
  Subsystems.PackPlate PackPlate8(T_0=global.T_0)
        ...
        rotation=90,
        origin={141,-80})));
  CellModels.Module12_withSpacer M_10(T_0=global.T_0)
                                          annotation (Placement(transformation(
        extent={{16,-10},{-16,10}},
        rotation=90,
        origin={166,-80})));
  CellModels.Module12_withSpacer M_11(T_0=global.T_0)
                                          annotation (Placement(transformation(
        extent={{-16,-10},{16,10}},
        rotation=90,
        origin={-170,0})));
  Subsystems.PackPlate PackPlate9(T_0=global.T_0)
        ...
        rotation=90,
        origin={-153,0})));
  CellModels.Module12_withSpacer M_12(T_0=global.T_0)
                                          annotation (Placement(transformation(
        extent={{16,-10},{-16,10}},
        rotation=90,
        origin={-136,0})));
  Subsystems.PackPlate PackPlate10(T_0=global.T_0)
        ...
        rotation=90,
        origin={-119,0})));
  CellModels.Module12_withSpacer M_13(T_0=global.T_0)
                                          annotation (Placement(transformation(
        extent={{-16,-10},{16,10}},
        rotation=90,
        origin={-102,0})));
  Subsystems.PackPlate PackPlate11(T_0=global.T_0)
        ...
        rotation=90,
        origin={-79,0})));
  CellModels.Module12_withSpacer M_14(T_0=global.T_0)
                                          annotation (Placement(transformation(
        extent={{16,-10},{-16,10}},
        rotation=90,
        origin={-54,0})));
  Subsystems.PackPlate PackPlate12(T_0=global.T_0)
        ...
        rotation=90,
        origin={-37,0})));
  CellModels.Module12_withSpacer M_15(T_0=global.T_0)
                                          annotation (Placement(transformation(
        extent={{-16,-10},{16,10}},
        rotation=90,
        origin={-20,0})));
  Subsystems.PackPlate PackPlate13(T_0=global.T_0)
        ...
        rotation=90,
        origin={-3,0})));
  CellModels.Module12_withSpacer M_16(T_0=global.T_0)
                                          annotation (Placement(transformation(
        extent={{16,-10},{-16,10}},
        rotation=90,
        origin={14,0})));
  Subsystems.PackPlate PackPlate14(T_0=global.T_0)
        ...
        rotation=90,
        origin={31,0})));
  CellModels.Module12_withSpacer M_17(T_0=global.T_0)
                                          annotation (Placement(transformation(
        extent={{-16,-10},{16,10}},
        rotation=90,
        origin={48,0})));
  Subsystems.PackPlate PackPlate15(T_0=global.T_0)
        ...
        rotation=90,
        origin={65,0})));
  CellModels.Module12_withSpacer M_18(T_0=global.T_0)
                                          annotation (Placement(transformation(
        extent={{16,-10},{-16,10}},
        rotation=90,
        origin={82,0})));
  Subsystems.PackPlate PackPlate16(T_0=global.T_0)
        ...
        rotation=90,
        origin={99,0})));
  CellModels.Module12_withSpacer M_19(T_0=global.T_0)
                                          annotation (Placement(transformation(
        extent={{-16,-10},{16,10}},
        rotation=90,
        origin={116,0})));
  Subsystems.PackPlate PackPlate17(T_0=global.T_0)
        ...
        rotation=90,
        origin={141,0})));
  CellModels.Module12_withSpacer M_20(T_0=global.T_0)
                                          annotation (Placement(transformation(
        extent={{16,-10},{-16,10}},
        rotation=90,
        origin={166,0})));
  CellModels.Module12_withSpacer M_21(T_0=global.T_0)
                                          annotation (Placement(transformation(
        extent={{-16,-10},{16,10}},
        rotation=90,
        origin={-170,80})));
  Subsystems.PackPlate PackPlate18(T_0=global.T_0)
        ...
        rotation=90,
        origin={-153,80})));
  CellModels.Module12_withSpacer M_22(T_0=global.T_0)
                                          annotation (Placement(transformation(
        extent={{16,-10},{-16,10}},
        rotation=90,
        origin={-136,80})));
  Subsystems.PackPlate PackPlate19(T_0=global.T_0)
        ...
        rotation=90,
        origin={-119,80})));
  CellModels.Module12_withSpacer M_23(T_0=global.T_0)
                                          annotation (Placement(transformation(
        extent={{-16,-10},{16,10}},
        rotation=90,
        origin={-102,80})));
  Subsystems.PackPlate PackPlate20(T_0=global.T_0)
        ...
        rotation=90,
        origin={-79,80})));
  CellModels.Module12_withSpacer M_24(T_0=global.T_0)
                                          annotation (Placement(transformation(
        extent={{16,-10},{-16,10}},
        rotation=90,
        origin={-54,80})));
  Subsystems.PackPlate PackPlate21(T_0=global.T_0)
        ...
        rotation=90,
        origin={-37,80})));
  CellModels.Module12_withSpacer M_25(T_0=global.T_0)
                                          annotation (Placement(transformation(
        extent={{-16,-10},{16,10}},
        rotation=90,
        origin={-20,80})));
  Subsystems.PackPlate PackPlate22(T_0=global.T_0)
        ...
        rotation=90,
        origin={-3,80})));
  CellModels.Module12_withSpacer M_26(T_0=global.T_0)
                                          annotation (Placement(transformation(
        extent={{16,-10},{-16,10}},
        rotation=90,
        origin={14,80})));
  Subsystems.PackPlate PackPlate23(T_0=global.T_0)
        ...
        rotation=90,
        origin={31,80})));
  CellModels.Module12_withSpacer M_27(T_0=global.T_0)
                                          annotation (Placement(transformation(
        extent={{-16,-10},{16,10}},
        rotation=90,
        origin={48,80})));
  Subsystems.PackPlate PackPlate24(T_0=global.T_0)
        ...
        rotation=90,
        origin={65,80})));
  CellModels.Module12_withSpacer M_28(T_0=global.T_0)
                                          annotation (Placement(transformation(
        extent={{16,-10},{-16,10}},
        rotation=90,
        origin={82,80})));
  Subsystems.PackPlate PackPlate25(T_0=global.T_0)
        ...
        rotation=90,
        origin={99,80})));
  CellModels.Module12_withSpacer M_29(T_0=global.T_0)
                                          annotation (Placement(transformation(
        extent={{-16,-10},{16,10}},
        rotation=90,
        origin={116,80})));
  Subsystems.PackPlate PackPlate26(T_0=global.T_0)
        ...
        rotation=90,
        origin={141,80})));
  CellModels.Module12_withSpacer M_30(T_0=global.T_0)
                                          annotation (Placement(transformation(
        extent={{16,-10},{-16,10}},
        rotation=90,
        origin={166,80})));
...
equation
  ...
  connect(M_21.port_a, PackSpacer.port_b1)
    annotation (Line(points={{-170,62},{-170,46}},   color={191,0,0}));
  connect(M_11.port_b, PackSpacer.port_b)
    annotation (Line(points={{-170,18},{-170,34}},   color={191,0,0}));
  ...
  connect(M_22.port_b, PackSpacer1.port_b1)
    annotation (Line(points={{-136,62},{-136,46}},   color={191,0,0}));
  ...
  connect(M_23.port_a, PackSpacer2.port_b1)
    annotation (Line(points={{-102,62},{-102,46}},   color={191,0,0}));
  ...
  connect(PackSpacer3.port_b1, M_24.port_b)
    annotation (Line(points={{-54,46},{-54,62}},   color={191,0,0}));
  ...
  connect(PackSpacer4.port_b1, M_25.port_a)
    annotation (Line(points={{-20,46},{-20,62}},   color={191,0,0}));
  ...
  connect(PackSpacer5.port_b1, M_26.port_b)
    annotation (Line(points={{14,46},{14,62}},   color={191,0,0}));
  ...
  connect(PackSpacer6.port_b1, M_27.port_a)
    annotation (Line(points={{48,46},{48,62}},   color={191,0,0}));
  ...
  connect(PackSpacer7.port_b1, M_28.port_b)
    annotation (Line(points={{82,46},{82,62}},   color={191,0,0}));
  ...
  connect(PackSpacer8.port_b1, M_29.port_a)
    annotation (Line(points={{116,46},{116,62}},   color={191,0,0}));
  ...
  connect(PackSpacer9.port_b1, M_30.port_b)
    annotation (Line(points={{166,46},{166,62}},   color={191,0,0}));
  ...
  connect(PackSpacer1.port_b, M_12.port_a)
    annotation (Line(points={{-136,34},{-136,18}},   color={191,0,0}));
  connect(PackSpacer2.port_b, M_13.port_b)
    annotation (Line(points={{-102,34},{-102,18}},   color={191,0,0}));
  connect(PackSpacer3.port_b, M_14.port_a)
    annotation (Line(points={{-54,34},{-54,18}},   color={191,0,0}));
  connect(PackSpacer4.port_b, M_15.port_b)
    annotation (Line(points={{-20,34},{-20,18}},   color={191,0,0}));
  connect(PackSpacer5.port_b, M_16.port_a)
    annotation (Line(points={{14,34},{14,18},{14,18}},   color={191,0,0}));
  connect(PackSpacer6.port_b, M_17.port_b)
    annotation (Line(points={{48,34},{48,18}},   color={191,0,0}));
  connect(PackSpacer7.port_b, M_18.port_a)
    annotation (Line(points={{82,34},{82,18}},   color={191,0,0}));
  connect(PackSpacer8.port_b, M_19.port_b)
    annotation (Line(points={{116,34},{116,18}},   color={191,0,0}));
  connect(PackSpacer9.port_b, M_20.port_a)
    annotation (Line(points={{166,34},{166,18}},   color={191,0,0}));
  ...
  connect(M_18.port_b, PackSpacer26.port_b1)
    annotation (Line(points={{82,-18},{82,-34}},   color={191,0,0}));
  connect(M_17.port_a, PackSpacer25.port_b1)
    annotation (Line(points={{48,-18},{48,-34}},   color={191,0,0}));
  connect(M_16.port_b, PackSpacer24.port_b1)
    annotation (Line(points={{14,-18},{14,-34}},   color={191,0,0}));
  connect(M_15.port_a, PackSpacer23.port_b1)
    annotation (Line(points={{-20,-18},{-20,-34}},   color={191,0,0}));
  connect(M_14.port_b, PackSpacer22.port_b1) annotation (Line(
        points={{-54,-18},{-54,-34},{-54,-34}},   color={191,0,0}));
  connect(M_13.port_a, PackSpacer21.port_b1)
    annotation (Line(points={{-102,-18},{-102,-34}},   color={191,0,0}));
  connect(M_12.port_b, PackSpacer20.port_b1)
    annotation (Line(points={{-136,-18},{-136,-34}},   color={191,0,0}));
  ...
  connect(M_04.port_a, PackSpacer22.port_b)
    annotation (Line(points={{-54,-62},{-54,-46}}, color={191,0,0}));
  connect(M_05.port_b, PackSpacer23.port_b)
    annotation (Line(points={{-20,-62},{-20,-46}}, color={191,0,0}));
  connect(M_06.port_a, PackSpacer24.port_b)
    annotation (Line(points={{14,-62},{14,-46}}, color={191,0,0}));
  connect(M_07.port_b, PackSpacer25.port_b)
    annotation (Line(points={{48,-62},{48,-46}}, color={191,0,0}));
  connect(M_08.port_a, PackSpacer26.port_b)
    annotation (Line(points={{82,-62},{82,-46}}, color={191,0,0}));
  connect(M_09.port_b, PackSpacer27.port_b)
    annotation (Line(points={{116,-62},{116,-46}}, color={191,0,0}));
  connect(M_10.port_a, PackSpacer28.port_b)
    annotation (Line(points={{166,-62},{166,-46}},   color={191,0,0}));
  ...
  connect(M_01.port_a, Heater.heat_port) annotation (Line(points={{-170,-98},{-170,
          -98},{-192,-98},{-192,-80}}, color={191,0,0}));
  connect(ground.p, M_01.pin_n) annotation (Line(
      points={{-200,0},{-200,-60},{-176,-60},{-176,-63.2},{-176.8,-63.2}},
      color={0,0,255},
      thickness=0.5));
  connect(load.p, M_21.pin_p) annotation (Line(points={{-200,40},{-200,60},{
          -176.8,60},{-176.8,63.2}}, color={0,0,255}));
  connect(load.n, ground.p)
    annotation (Line(points={{-200,20},{-200,-1.77636e-15}}, color={0,0,255}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},
        ...
        Rectangle(
          ...
          fillPattern=FillPattern.Solid,
          pattern=LinePattern.None)}));
end BatteryPack_withCellSpacers;
