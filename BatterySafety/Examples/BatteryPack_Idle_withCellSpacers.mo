...
model BatteryPack_Idle_withCellSpacers "Battery Pack Example"
...
equation
  ...
  connect(load.n, ground.p)
    annotation (Line(points={{-200,30},{-200,30},{-200,0}}, color={0,0,255}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},
        ...
        Rectangle(
          ...
          fillPattern=FillPattern.Solid,
          pattern=LinePattern.None)}));
end BatteryPack_Idle_withCellSpacers;
