...
model BatteryPack "Battery Pack Example"
...
equation
  ...
  connect(ground.p, M_01.pin_n) annotation (Line(points={{-200,0},{-200,-60},{
          -176.8,-60},{-176.8,-63.2}}, color={0,0,255}));
  connect(load.n, ground.p)
    annotation (Line(points={{-200,30},{-200,-1.77636e-15}}, color={0,0,255}));
